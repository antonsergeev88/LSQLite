...
@frozen public struct Datatype: Equatable, RawRepresentable, CustomDebugStringConvertible {
    ...
    /// Debug-friendly SQLite type name.
    ///
    /// Related SQLite: `SQLITE_INTEGER`, `SQLITE_FLOAT`, `SQLITE_BLOB`, `SQLITE_NULL`, `SQLITE_TEXT`
