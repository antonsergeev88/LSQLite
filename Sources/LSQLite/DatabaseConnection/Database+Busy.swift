...
extension Database {
    public typealias BusyHandler = @convention(c) (_ context: UnsafeMutableRawPointer?, _ attempt: Int32) -> Int32
    ...
    @inlinable public func setBusyHandler(context: UnsafeMutableRawPointer? = nil, _ handler: BusyHandler? = nil) -> ResultCode {
        sqlite3_busy_handler(rawValue, handler, context).resultCode
    }
